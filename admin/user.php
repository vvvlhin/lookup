...
<body>
        ...
        <nav class="sidebar-nav">
            <ul>
                <li class="nav-item nav-item-has-children">
                    <a href="../admin/index.php?page=0" class="collapsed" data-bs-toggle="collapse"
                        data-bs-target="#ddmenu_1" aria-controls="ddmenu_1" aria-expanded="false"
              ...
              <a href="index.html" class="active"> eCommerce </a>
                ...
                <li class="nav-item nav-item-has-children">
                    <a href="#0" data-bs-toggle="collapse" data-bs-target="#ddmenu_2" aria-controls="ddmenu_2"
                        ...
                        <span style="font-weight: bold;" class="text">Пользователи</span>
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a href="../admin/image.php?page=0" class="collapsed" data-bs-toggle="collapse"
                        data-bs-target="#ddmenu_2" aria-controls="ddmenu_2" aria-expanded="false"
                        aria-label="Toggle navigation">
                        <span class="icon">
                ...
                <li class="nav-item nav-item-has-children">
                    <a href="../admin/groups.php?page=0" class="collapsed" data-bs-toggle="collapse"
                        data-bs-target="#ddmenu_2" aria-controls="ddmenu_2" aria-expanded="false"
                        aria-label="Toggle navigation">
                        <span class="icon">
                            <svg id="svg" fill="#000000" stroke="#000000" width="20px" height="20px" version="1.1"
    ...
    <main class="main-wrapper">
                    ...
                    <div class="col-lg-5 col-md-5 col-6">
                        <div class="header-left d-flex align-items-center">
                            ...
                            <div class="header-search d-none d-md-flex">
                                <form action="#">
                                    <input id="live_search" type="text" placeholder="Поиск по имени..." />
        ...
        <section class="section">
            <h1 style="padding: 25px 50px;">Список пользователей</h1>
            <div class="table-section">
                <table>
                    <thead>
                        <tr>
                            <th style="text-align: center;">ID пользователя</th>
                            <th>Никнейм</th>
                    ...
                    <tbody>
                        <?
                        $sql = mysqli_query($connect, "SELECT * FROM `clients` WHERE clients.admin = 1 || clients.admin = 2;");
                        $products = array();
                        ...
                        <? foreach ($products as $key => $product): ?>
                            <tr class="row__group">
                                <td id="id" style="text-align: center;"><?= $product['Code_clients'] ?></td>
                                <td><?= $product['names'] ?></td>
                                <td><?= $product['phone'] ?></td>
                                <td><?= $product['email'] ?></td>
                                <td>
                                    ...
                                    if ($product['admin'] == 1) {
                                        echo "
                                        <select style='color: red;' name=select class=select-admin name=language>
                                            <option hidden value=''>Админ</option>
                                            <option style='color: blue;' value='2'>Модератор</option>
                                        </select>
                                        ";
                                    } else {
                                        echo "
                                        <select style='color: blue;' name=select class=select-admin name=language>
                                            <option hidden value=''>Модератор</option>
                                            <option style='color: red;' value='1'>Админ</option>
                                        </select>
                                        ";
                                    }
                                    ?>
                                </td>
                                <td class="crest" style="display: flex; justify-content: center;">
                                    <div id="mdiv">
                                        <div class="mdiv">
                                            <div class="md"></div>
                                        </div>
