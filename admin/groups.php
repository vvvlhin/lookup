...
<body>
  <div class="auth">
    <div class="main">
      <div class="flex-main">
        <h3 id="main-header-text">Добавление группы товара</h3>
  ...
  <div class="blur">
    ...
    <main class="main-wrapper">
      ...
      <section class="section">
        <h1 class="preview-text" style="padding: 25px 50px;">Список групп товаров
        ...
        <div class="table-section">
          <table>
            <thead>
              <tr>
                <th style="text-align: center;">ID группы</th>
                <th>группа</th>
              </tr>
            </thead>
            <tbody class="tbody">
              ...
              $res_count = mysqli_query($connect, "SELECT COUNT(*) FROM group_tovar");
              if (isset($_GET['page'])) {
                $page = $_GET['page'];
              } else {
                $page = 1;
              ...
              $sql = mysqli_query($connect, "SELECT * FROM group_tovar ORDER BY Code_group_tovar DESC LIMIT " . $number . ", " . $limit . "");
              $products = array();
              ...
              <? foreach ($products as $key => $product): ?>
                <tr class="row__group">
                  <td id="id" style="text-align: center;"><?= $product['Code_group_tovar'] ?></td>
                  <td id="id" style="text-align: center;"><?= $product['name_group'] ?></td>
                  <td><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" id="edit-group"
