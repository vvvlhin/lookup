...
<body>
    ...
    <div class="main-container">
        <div class="top-block-wrapper">
            <div id="top-block-wrapper-preview-text">Каталог</div>
        </div>
        <ul class="navigation">
            <li>Главная</li>
            <li> — </li>
        ...
        <div class="wrapper-main-block">
            ...
            <ul class="catalog-card">
                ...
                ?>
                <a class="catalog-card-item-link" href="coffee/coffee.php">
                    <li class="catalog-card-item">
                        <img class="catalog-card-item-img" src="../img/filter.webp" alt="">
                        <div class="catalog-card-item-text">
                            <span>
                                Кофе
                            </span>
                ...
                <?
                $sql = mysqli_query($connect, "SELECT COUNT(*) as kol_vo FROM `Tovar`WHERE Groups_tovar = 2;");
                $res = mysqli_fetch_assoc($sql);
                ?>
                <a class="catalog-card-item-link" href="tea/coffee.php">
                    <li class="catalog-card-item">
                        <img class="catalog-card-item-img" src="../img/earl_gray.jpg" alt="">
                        <div class="catalog-card-item-text">
                            <span>
                                Чай
                            </span>
