...
document.querySelector('#price').addEventListener("click", () => {
  if (document.querySelector('.price-block').style.display == "none") {
    ...
    document.querySelector('.kisl-block').style.display = "none"
    document.querySelector('.gorech-block').style.display = "none"
    document.querySelector('.poln-block').style.display = "none"
  } else {
...
document.querySelector('#kisl').addEventListener("click", () => {
  if (document.querySelector('.kisl-block').style.display == "none") {
    document.querySelector('.kisl-block').style.display = "block";
    document.querySelector('.stock-block').style.display = "none";
    document.querySelector('.price-block').style.display = "none";
    document.querySelector('.gorech-block').style.display = "none"
    document.querySelector('.poln-block').style.display = "none"
...
document.querySelector('#gorech').addEventListener("click", () => {
  if (document.querySelector('.gorech-block').style.display == "none") {
    document.querySelector('.gorech-block').style.display = "block";
    document.querySelector('.kisl-block').style.display = "none";
    document.querySelector('.stock-block').style.display = "none";
    document.querySelector('.price-block').style.display = "none";
    document.querySelector('.poln-block').style.display = "none"
...
document.querySelector('#poln').addEventListener("click", () => {
  if (document.querySelector('.poln-block').style.display == "none") {
    document.querySelector('.poln-block').style.display = "block";
    document.querySelector('.gorech-block').style.display = "none";
    document.querySelector('.kisl-block').style.display = "none";
    document.querySelector('.stock-block').style.display = "none";
    document.querySelector('.price-block').style.display = "none";
