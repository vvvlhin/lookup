...
<body>
    ...
    <div class="main-container">
        <?
        $sql = mysqli_query($connect, "SELECT COUNT(*) as kol_vo FROM `Tovar`WHERE category = 3;");
        $res = mysqli_fetch_assoc($sql);
        ?>
        <div class="top-block-wrapper">
            <div id="top-block-wrapper-preview-text">Моносорта<span
