...
<body>
    ...
    <div class="main-container">
        <?
        $sql = mysqli_query($connect, "SELECT COUNT(*) as kol_vo FROM `Tovar`WHERE category = 1;");
        $res = mysqli_fetch_assoc($sql);
        ?>
        <div class="top-block-wrapper">
            <div id="top-block-wrapper-preview-text">Ароматизированный кофе<span
        ...
        <div class="wrapper-main-block">
            <div class="wrapper-inner">
                ...
                <ul style="display: block;" class="menu-dropdown">
                    <li id="menu-dropdown-item" style="background-color: #fafafa;">
            ...
            <div class="goods-wrapper">
                <div class="sort">
                    ...
                    <ul class="sort-list">
                        ...
                        <li class="sort-list-item" id="kisl">
                            Кислотность
                            <i class="svg  svg-inline-down colored_theme_hover_bg-el" aria-hidden="true">
                                <svg xmlns="http://www.w3.org/2000/svg" width="5" height="3" viewBox="0 0 5 3">
                                    <path class="cls-1" d="M250,80h5l-2.5,3Z" transform="translate(-250 -80)">
                        ...
                        <ul style="display: none;" class="kisl-block">
                            <li class="stock-item">
                                <input onclick="kisl()" id="kisl-input1" style="width: auto;" type="checkbox">
                                Минимальная
                            </li>
                            <li class="stock-item">
                                <input onclick="kisl()" id="kisl-input2" style="width: auto;" type="checkbox">
                                Низкая
                            </li>
                            <li class="stock-item">
                                <input onclick="kisl()" id="kisl-input3" style="width: auto;" type="checkbox">
                                Средняя
                            </li>
                            <li class="stock-item">
                                <input onclick="kisl()" id="kisl-input4" style="width: auto;" type="checkbox">
                                Повышенная
                            </li>
                            <li class="stock-item">
                                <input onclick="kisl()" id="kisl-input5" style="width: auto;" type="checkbox">
                                Высокая
                            </li>
                        </ul>
                        <li class="sort-list-item" id="gorech">
                            Горечь
                            <i class="svg  svg-inline-down colored_theme_hover_bg-el" aria-hidden="true">
                                <svg xmlns="http://www.w3.org/2000/svg" width="5" height="3" viewBox="0 0 5 3">
                                    <path class="cls-1" d="M250,80h5l-2.5,3Z" transform="translate(-250 -80)">
                        ...
                        <ul style="display: none;" class="gorech-block">
                            <li class="stock-item">
                                <input onclick="kisl()" id="gorech-input1" style="width: auto;" type="checkbox">
                                Минимальная
                            </li>
                            <li class="stock-item">
                                <input onclick="kisl()" id="gorech-input2" style="width: auto;" type="checkbox">
                                Низкая
                            </li>
                            <li class="stock-item">
                                <input onclick="kisl()" id="gorech-input3" style="width: auto;" type="checkbox">
                                Средняя
                            </li>
                            <li class="stock-item">
                                <input onclick="kisl()" id="gorech-input4" style="width: auto;" type="checkbox">
                                Повышенная
                            </li>
                            <li class="stock-item">
                                <input onclick="kisl()" id="gorech-input5" style="width: auto;" type="checkbox">
                                Высокая
                            </li>
                        </ul>
                        <li class="sort-list-item" id="poln">
                            Полнотелость
                            <i class="svg  svg-inline-down colored_theme_hover_bg-el" aria-hidden="true">
                                <svg xmlns="http://www.w3.org/2000/svg" width="5" height="3" viewBox="0 0 5 3">
                                    <path class="cls-1" d="M250,80h5l-2.5,3Z" transform="translate(-250 -80)">
                        ...
                        <ul style="display: none;" class="poln-block">
                            <li class="stock-item">
                                <input onclick="kisl()" id="poln-input1" style="width: auto;" type="checkbox">
                                Минимальная
                            </li>
                            <li class="stock-item">
                                <input onclick="kisl()" id="poln-input2" style="width: auto;" type="checkbox">
                                Низкая
                            </li>
                            <li class="stock-item">
                                <input onclick="kisl()" id="poln-input3" style="width: auto;" type="checkbox">
                                Средняя
                            </li>
                            <li class="stock-item">
                                <input onclick="kisl()" id="poln-input4" style="width: auto;" type="checkbox">
                                Повышенная
                            </li>
                            <li class="stock-item">
                                <input onclick="kisl()" id="poln-input5" style="width: auto;" type="checkbox">
                                Высокая
                            </li>
                        </ul>
                    </ul>
