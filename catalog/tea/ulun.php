...
<body>
    ...
    <div class="main-container">
        <?
        $sql = mysqli_query($connect, "SELECT COUNT(*) as kol_vo FROM `Tovar`WHERE Groups_tovar = 2 AND category = 12;");
        $res = mysqli_fetch_assoc($sql);
        ?>
        <div class="top-block-wrapper">
            <div id="top-block-wrapper-preview-text">Улун<span
                ...
                <div class="sort">
                    ...
                    <ul class="sort-list">
                        ...
                        <div style="display: none;" class="price-block">
                            ...
                            <?
                            $sql = mysqli_query($connect, "SELECT MIN(cost250) as min, MAX(cost250) as max FROM `Tovar` WHERE Groups_tovar = 2 AND category = 12");
                            $res = mysqli_fetch_assoc($sql);
                            ?>
                            <div id="slider-range">
