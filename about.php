...
<body>
    ...
    <div class="main-container">
        <div class="top-block-wrapper">
            <div id="top-block-wrapper-preview-text">О компании</div>
        </div>
        <ul class="navigation">
            <li>Главная</li>
            <li> — </li>
        ...
        <div class="text-pre">
            ...
            Мы начинали обжаривать зерно с помощью небольшого ростера из Сербии. Сейчас жарим на Probat G120 HS с
            автоматизированной системой контроля и профилирования обжарки. Используем кофемолку Mahlkoenig
            производительностью 4000 кг в день. Каждый год улучшаем рецептуру смесей и повышаем свою квалификацию.
            Благодаря промышленному ростеру Probat G120 мы можем обжарить до 7-ми тонн зерна в день.

            <div style="font-size: 20px; margin: 10px 0 ;">
                HoReCa, Вендинг
            </div>
            У нас вы найдете смеси и моносорта на любой вкус. Каждая смесь это результат долгих экспериментов с тоном
            обжарки, поиском сочетаний сортов арабики и робусты. Подберем смесь или разработаем уникальную специально
            для вас.

            <div style="font-size: 20px; margin: 10px 0 ;">
                Оптовикам
            </div>
            Мы можем жарить до 7 тонн зерна в день, а так же молоть 4000 кг в день. Фасуем в пакеты различных расцветок
            с зип-локом от 250 до 1000 грамм. Пакеты укладываем в коробки по 10 или 20 кг. Можем фасовать в бумажные
            мешки объёмом 20 кг с полиэтиленом и без него.
        </div>
    </div>
    <footer>
