...
<body>
                ...
                <?php if (!empty($_SESSION['auth'])): ?>
                    <ul class="profile-box">
                        ...
                        <ul class="profile-box-sub-menu">
                            ...
                            <a href="private.php">
                                <li style="font-weight: bold;" id="profile-box-sub-menu-item">Личные данные</li>
                            </a>
                            <a href="">
                                <li id="profile-box-sub-menu-item">История заказов</li>
                            </a>
    ...
    <div class="main-container-wrapper">
        <div class="main-container">
            <div class="top-block-wrapper">
                <div id="top-block-wrapper-preview-text">Личные данные</div>
            </div>
            <ul class="navigation">
                <li>Главная</li>
                <li> — </li>
            ...
            <div class="prime">
                <ul class="prime-sidebar">
                    <a href="personal_account.php">
                        <li id="prime-sidebar-item">Мой кабинет</li>
                    </a>
                    <a href="order.php">
                        <li id="prime-sidebar-item">Текущие заказы</li>
                    </a>
                    <a href="private.php">
                        <li id="prime-sidebar-item" class="prime-sidebar-item-selected">Личные данные</li>
                    </a>
                    <li id="prime-sidebar-item">История заказов</li>
                    <li id="prime-sidebar-item">Выйти</li>
                </ul>
                <ul class="prime-panel-private">
                    <form method="post" id="form">
                        <div class="alert-success">Изменения сохранены</div>
                        <div class="desription-text">
                            <h1 for="first">
                                Имя <span id="red">*</span>
                            </h1>
                            <div class="input-wrapper">
                                <? foreach ($products as $product): ?>
                                    <input type="text" id="first" name="name" value="<?= $product['names'] ?>">
                                    <div class="desription-text">Заполните, чтобы мы знали, как к вам обращаться</div>
                                </div>
                            </div>
                            <div class="desription-text">
                                <h1 for="password">
                                    E-mail <span id="red">*</span>
                                </h1>
                                <div class="input-wrapper">
                                    <input type="text" id="password" name="email" value="<?= $product['email'] ?>">
                                    <div class="desription-text"> Для отправки уведомлений о статусе заказа. Используйте как
                                        логин для входа в личный кабинет</div>
                                </div>
                            </div>
                            <div class="desription-text">
                                <h1 for="password">
                                    Телефон <span id="red">*</span>
                                </h1>
                                <div class="input-wrapper">
                                    <input type="text" id="password" name="phone" value="<?= $product['phone'] ?>">
                                    <div class="desription-text">Необходим для уточнения деталей заказа</div>
                                </div>
                            </div>
                            <div class="wrap">
                                <input type="submit" class="sub" value="Сохранить изменения">
                            </div>
                        </form>
                    <? endforeach ?>
                </ul>
    ...
    <script src="personal_account.js"></script>
</body>
