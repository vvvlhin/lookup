                    ...
                    <?php if (!empty($_SESSION['auth'])): ?>
                        <ul class="profile-box">
                            ...
                            <ul class="profile-box-sub-menu">
                                ...
                                <a href="order.php">
                                    <li style="font-weight: bold;" id="profile-box-sub-menu-item">Текущие заказы</li>
                                </a>
                                <a href="private.php">
    ...
    <div class="main-container-wrapper">
        <div class="main-container">
            <div class="top-block-wrapper">
                <div id="top-block-wrapper-preview-text">Мои заказы</div>
            </div>
            <ul class="navigation">
                <li>Главная</li>
                <li> — </li>
            ...
            <div class="prime">
                <ul class="prime-sidebar">
                    ...
                    <li id="prime-sidebar-item" class="prime-sidebar-item-selected">Текущие заказы</li>
                    <a href="private.php">
                ...
                <ul class="prime-panel-order">
                    <div class="prime-panel-text">Текущие заказы не найдены</div>
                    <ul class="prime-panel-list">
                        <li id="prime-panel-list-item">
                            <span id="prime-panel-list-item-text">
