            ...
            <div class="main-container">
                ...
                <div class="prime">
                    ...
                    <ul class="prime-panel">
                        <a class="prime-panel-link" href="order.php">
                            <li id="prime-panel-item">
                                <i class="svg inline  svg-inline-cur_orders colored" aria-hidden="true"><svg
                                        data-name="Group 188 copy 3" xmlns="http://www.w3.org/2000/svg" width="50"
                        ...
                        <a class="prime-panel-link" href="private.php">
                            <li id="prime-panel-item">
                                <i class="svg inline  svg-inline-personal colored" aria-hidden="true"><svg
                                        data-name="Group 189 copy 3" xmlns="http://www.w3.org/2000/svg" width="50"
                                        height="50" viewBox="0 0 50 50">
                                        <defs>
                                            <style>
                                                .cls-1,
                        ...
                        <a class="prime-panel-link" href="">
                            <li id="prime-panel-item">
                                <i class="svg inline  svg-inline-filter_orders colored" aria-hidden="true"><svg
                                        data-name="Group 190 copy 3" xmlns="http://www.w3.org/2000/svg" width="50"
                                        height="50" viewBox="0 0 50 50">
                                        <defs>
                                            <style>
                                                .cls-1,
