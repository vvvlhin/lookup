...
<body>
    ...
    <div class="main-container">
        ...
        <div class="main-content">
            ...
            <h1 id="main-content-text">Ваш заказ успешно оформлен. Мы свяжемся с вами в ближайшее время</h1> <br>
            <h1 id="main-content-text">Номер вашего заказа: <span id="main-content-text-red">
                    <?php
            ...
            <iframe style="display: block; opacity: 1;" src="check.php" width="1" height="1" frameborder="0"></iframe>
        </div>
    </div>
    <hr>
    <footer>
