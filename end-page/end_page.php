    ...
    <div class="blur">
        ...
        <div class="main-container">
            ...
            <div class="main-content">
                <div class="img-wrapper" style="display: flex; justify-content: center; margin: 10px 0;">
                    <img style="width: 150px;" src="../img/free-png.ru-39.png" alt="">
                </div>
                <div class="wrapper-text">
                    <div>Спасибо!</div>
                </div>
                <div id="main-content-text">Ваш заказ успешно оформлен. Мы свяжемся с вами в ближайшее время</div> <br>
                <div id="main-content-text">Номер вашего заказа: <span id="main-content-text-red">
                        <?php
                ...
                <a href="../main/index.php">
                    <div class="back-btn-block">
                        <div class="back-btn">Вернуться на главную</div>
                    </div>
                </a>
                <iframe style="display: block; opacity: 1;" src="check.php" width="1" height="1"
